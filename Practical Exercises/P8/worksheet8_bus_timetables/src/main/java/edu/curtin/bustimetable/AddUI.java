...
/**
 * Manages the dialog box for adding new timetable entries. The user enters five details: the 
...
public class AddUI
{
    ...
    /**
     * Shows the dialog, and (if the user clicks 'ok') adds a new TimetableEntry object to the list.
     */
    ...
    /**
     * Checks whether the current field values represent a valid timetable entry. If not, the 'ok' 
    ...
    private void validateEntry()
    {
        ...
        catch(NumberFormatException e) {} // Unparseable
