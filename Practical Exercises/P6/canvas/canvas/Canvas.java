...
/** 
 * Represents a Swing-based 'drawing surface', on which a client can draw coloured lines. This 
 ...
 * lineTo() - draws a line from the current location to a new location, in the current foreground 
 *    colour. The current location is updated to the new location.
 * registerHandler() - adds an event handler to receive the (x,y) location of mouse clicks.
...
public class Canvas
{
    ...
    private class CanvasPanel extends JPanel
    {
        public CanvasPanel()
        {
            // Set up the Swing event handler so that we can, in turn, invoke any scripts' event 
            // handlers.
    ...
    /** 
     * Use reflection as a short-cut to converting colour names into Color objects, based on the
    ...
    /**
     * API method - sets the foreground colour that will be used next time a line is drawn.
     */
    ...
    /** 
     * API method - draws a line from the current position to a new point, and updates the 
    ...
    /**
     * API method - allows a script/plugin to register an event handler for when the mouse is 
    ...
    /**
     * API method - allows a script/plugin to un-register a previously-registered event handler.
     */
